    ...
    if (saved) {
      data = data.map(s => {
        if (s.id === "jezyki-skryptowe") {
          ...
          if (defaultJs && (!s.modules || s.modules.length < 7 || !s.modules.some(m => m.id === "js-pe1-final"))) {
            console.log("Migrated 'jezyki-skryptowe' module database to include PE1 Modules 1-4 and Final Test.");
            return defaultJs;
          }
        }
